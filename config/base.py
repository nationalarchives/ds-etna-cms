...
WAGTAILIMAGES_IMAGE_MODEL = "images.BaseImage"
...
KONG_API_URL = os.getenv(
    "KONG_API_URL",
    "https://aa83a1e6831944fa8bcf17f5ce391b73-58be9fd587cba13e.elb.eu-west-2.amazonaws.com/api/v1/data",
)
KONG_API_KEY = os.getenv("KONG_API_KEY")
KONG_API_VERIFY_CERTIFICATES = False
